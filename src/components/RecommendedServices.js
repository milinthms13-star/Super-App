...
const MODULE_CATALOG = [
  ...
  { id: "billpay", title: "Nila Utility Hub", icon: "B", gradient: "linear-gradient(135deg, #0B2545 0%, #134E4A 55%, #1D4ED8 100%)" },
  { id: "skilllearning", title: "Nila Skill Hub", icon: "K", gradient: "linear-gradient(135deg, #1E1B4B 0%, #0F4C81 55%, #0EA5A7 100%)" },
  { id: "tourism", title: "NilaTravel", icon: "T", gradient: "linear-gradient(135deg, #0F766E 0%, #0EA5A7 45%, #14B8A6 100%)" },
  { id: "devadarshan", title: "Devadarshan", icon: "D", gradient: "linear-gradient(135deg, #0F4C81 0%, #1E3A8A 45%, #0EA5A7 100%)" },
  { id: "hyperlocal", title: "Nila Hyperlocal Delivery", icon: "H", gradient: "linear-gradient(135deg, #0F766E 0%, #0EA5A7 48%, #1D4ED8 100%)" },
  { id: "localservices", title: "Local Services Marketplace", icon: "L", gradient: "linear-gradient(135deg, #0A2342 0%, #0F766E 48%, #1D4ED8 100%)" },
...
const RecommendedServices = () => {
  ...
  const moduleStats = useMemo(() => {
    const values = {
      ...
      billpay: Array.isArray(mockData?.billTransactions) ? mockData.billTransactions.length : 0,
      skilllearning: Array.isArray(mockData?.courseEnrollments) ? mockData.courseEnrollments.length : 0,
      tourism: Array.isArray(mockData?.tourismBookings) ? mockData.tourismBookings.length : 0,
      devadarshan: Array.isArray(mockData?.templeBookings) ? mockData.templeBookings.length : 0,
      hyperlocal: Array.isArray(mockData?.hyperlocalOrders) ? mockData.hyperlocalOrders.length : 0,
      localservices: Array.isArray(mockData?.localServiceLeads) ? mockData.localServiceLeads.length : 0,
