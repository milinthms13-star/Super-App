...
export const PROFILE_ENRICHMENTS = [
  {
    ...
    hobbies: ["Travel", "Classical music", "Cooking"],
    privacy: { hidePhone: false, hidePhotos: false, premiumOnlyContact: true },
  ...
  },
  {
    ...
    privacy: { hidePhone: true, hidePhotos: true, premiumOnlyContact: true },
    premiumOnlyContact: true,
  },
  {
    community: "Gujarati",
    ...
    privacy: { hidePhone: true, hidePhotos: false, premiumOnlyContact: false },
    premiumOnlyContact: false,
  },
  {
    community: "Telugu",
    ...
    privacy: { hidePhone: false, hidePhotos: false, premiumOnlyContact: false },
    premiumOnlyContact: false,
  },
  {
    community: "Malayali",
    ...
    privacy: { hidePhone: true, hidePhotos: false, premiumOnlyContact: true },
    premiumOnlyContact: true,
  },
];
