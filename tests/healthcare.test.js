...
import Healthcare from '../src/modules/healthcare/Healthcare';
import { healthcareApi } from '../src/modules/healthcare/services/healthcareApi';
...
describe('Healthcare API Service', () => {
  ...
  test('handles API errors with fallback', async () => {
    ...
    const { healthcareApi: realApi } = require('../src/modules/healthcare/services/healthcareApi');
