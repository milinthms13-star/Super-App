...
const healthcareIdempotencyKeySchema = new mongoose.Schema(
  {
...
healthcareIdempotencyKeySchema.index(
  { userId: 1, key: 1, method: 1, routeKey: 1 },
  { unique: true, name: 'uniq_healthcare_idempotency_scope' }
);
healthcareIdempotencyKeySchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0, name: 'ttl_healthcare_idempotency_expiry' });

module.exports = mongoose.model('HealthcareIdempotencyKey', healthcareIdempotencyKeySchema);
