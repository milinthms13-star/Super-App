...
const InterestSchema = new mongoose.Schema({
  ...
  fromProfileId: { type: mongoose.Schema.Types.ObjectId, ref: 'MatrimonialProfile', required: true },
  toProfileId: { type: mongoose.Schema.Types.ObjectId, ref: 'MatrimonialProfile', required: true },
  status: { type: String, enum: ['sent', 'accepted', 'declined', 'expired'], default: 'sent' },
...
const ReportSchema = new mongoose.Schema({
  id: { type: String, default: () => crypto.randomUUID() },
  reporterId: { type: mongoose.Schema.Types.ObjectId, ref: 'MatrimonialProfile', required: true },
...
const MatrimonialProfileSchema = new mongoose.Schema({
  ...
  matchScoreCache: { type: Map, of: Number }, // Cache for performance
